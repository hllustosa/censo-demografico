...
O Aplicativo do Censo foi desenvolvido com base na arquitetura de microsserviços. A aplicação consiste de 3 microsserviços, a saber:
 ...
 - **Statistics**: Responsável por manter contadores com os dados estatísticos dos cidadãos pre agrupados. Este microsserviço mantém um conjunto de coleções (também no MongoDB) com os dados agrupados por categorias baseadas nas características de cada pessoa.
